...
public class P1_Mixedreality extends PApplet {
...
class Scenes {
  ...
  int fadeBoundary = 30;
  int fadeSpeed = 20;
  int slideshowFadeColor = color(230);
  ...
  int textMargin = 10;
  int textBackground = color(121, 157, 156);
...
class Sidebars {
  ...
  int clickedColor = color(125,100);
  int chosenColor = color(80, 219, 248);
  ...
  public void settings() {  size(1500, 690); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "P1_Mixedreality" };
    if (passedArgs != null) {
